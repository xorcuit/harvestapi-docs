...
fetch(`https://api.harvestapi.net/linkedin/geo-id-search?search=New York`, {
...
```bash cURL
curl --request GET \
  --url https://api.harvestapi.net/linkedin/geo-id-search?search=New%20York \
...
url = "https://api.harvestapi.net/linkedin/geo-id-search?search=New York"
