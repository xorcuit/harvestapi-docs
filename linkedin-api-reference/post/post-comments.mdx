---
title: 'Post comments'
openapi: 'GET /linkedin/post-comments'
---
...
```bash cURL
curl --request GET \
  --url https://api.harvest-api.com/linkedin/post-comments?post=https://www.linkedin.com/posts/microsoft-events_microsoft-build-has-arrived-in-seattle-and-ugcPost-7329991434395160578-GnK7?utm_source=share&utm_medium=member_desktop&rcm=ACoAACzazy4B3ajZsA0WxWr6m4S77iItYbYCLZM \
