...
fetch(`https://api.harvestapi.io/linkedin/profile-reactions?${params.toString()}`, {
...
```bash cURL
curl --request GET \
  --url https://api.harvestapi.io/linkedin/profile-reactions?profile=https://www.linkedin.com/in/satyanadella \
