...
To scrape the basic profile search from the https://www.linkedin.com/search/results/people/ web page, you can use our
[Profile Search](/linkedin-api-reference/profile/search) endpoint. This search can usually find profiles when searching by name.  
...
In comparison, your personal LinkedIn account will find more exposed profiles due to your number of connections.  
...
So either way, they won't simply allow you to extract search results.
Even LinkedIn's Business Premium subscription still limits your search results to 3rd-degree connections only
