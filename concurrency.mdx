...
Our average scraping time for companies is 1.2s. For profiles, it's 2.3s.  
This means on Basic plan, for example:

- 60 / 1.2 \* 6 ~ 300 req/min for companies on average
- 60 / 2.3 \* 6 ~ 156 req/min for profiles on average
